...
<html lang="en">
  <head>
    ...
    <!--Title Page-->
    <title>Cookie Policy | Municipal Agriculture Office Jimenez</title>
    ...
    <!-- ======= Home Section ======= -->
      <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="container text-center text-md-left" data-aos="fade-up">
          <h1>Cookie Policy</h1>
          <h2>Learn how we use cookies to provide you with the best browsing experience.</h2>
        </div>
      </section>
    <!-- End Home Selection -->
          ...
          <section class="what-we-do">
            <div class="container">
              ...
              <div class="section-title">
                <h5>Municipal Agriculture Office Jimenez uses cookies on www.maojimenez.ueuo.com and its various subdomains. By using our website, you consent to the use of cookies.</h5>
              </div>
            </div>
          </section>
        ...
        <div class="container">
          <div class="section-title">
            <div class="col-lg-12 col-md-12">
              ...
              <p>Cookies are small pieces of text files, sent by your browser from a website you visit. They allow our website or a third-party to recognize you. They also make your next site visit easier and will make the site more useful for you!</p>
            </div>
          </div>
        </div>
        <br><br><br>
        ...
        <div class="container">
          <div class="section-title">
            <div class="col-lg-12 col-md-12">
              ...
              <p>When you use and access our website, we may place a number of cookie files in your web browser. We use cookies to enable certain functions of the website, provide analytics, store your preferences. Please read our <a href="privacy-policy">Privacy Policy</a> to learn about how we value your privacy.</p>
            </div>
          </div>
        </div>
        <br><br><br>
        ...
        <div class="container">
          <div class="section-title">
            <div class="col-lg-12 col-md-12">
              ...
              <p>We may also use various third-parties' cookies to report usage statistics, deliver advertisements, and so on. These cookies from our partners are anonymous, don't store personally identifiable information, and store only user behavior on our website.</p>
            </div>
          </div>
        </div>

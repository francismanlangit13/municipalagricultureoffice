                ...
                <div class="card-body"> 
                    <div class="row">
                        <div class="col-md-6 mb-3 ml-4">                             
                            ...
                            <input type="file" class="input-large btn btn-secondary" name="profilepicture" id="image1" accept=".jpg, .jpeg, .png" value="" onchange="previewImage('frame1', 'image1')" required>

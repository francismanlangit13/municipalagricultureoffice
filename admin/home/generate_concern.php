...
<ol class="breadcrumb mb-4">    
  ...
  <li class="breadcrumb-item">Concern Report</li>
</ol>
    ...
    <div id="outprint">
        ...
        <div class="container-fluid">
			<div class="row">
				...
				<div class="col-8">
					<h4 class="text-center"><b>Municipal Agriculture Office</b></h4>
					<h3 class="text-center"><b>Date-wise Transaction Report</b></h3>
					<h5 class="text-center"><b>as of</b></h5>
					<h5 class="text-center"><b><?php date("F d, Y", strtotime($from)). " - ".date("F d, Y", strtotime($to)) ?></b></h5>
				</div>
				<div class="col-2"></div>
			</div>
			<table class="table table-bordered table-hover table-striped">
				...
				<tbody>
					<?php 
						$i = 1;
						$qry = $con->query("SELECT * from `concern` where date(date_created) between '{$from}' and '{$to}' order by unix_timestamp(date_created) asc ");

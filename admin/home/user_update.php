                ...
                <div class="card-body">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input required type="email" name="email" value="<?=$row['email'];?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control">
                        </div>
                    
                        <div class="col-md-4 mb-3">
                            <label for="" class="required">Phone Number</label>
                            <input required type="text" name="phone" value="<?=$row['phone'];?>" pattern="09[0-9]{9}" maxlength="11" class="form-control">
                        </div>

...
<html lang="en">
    ...
    <head>
        ...
        <title>Site Map | Municipal Agriculture Office Jimenez</title>
    ...
    <body>
        ...
        <main id="main">
            ...
            <section class="what-we-do">
                ...
                <label><b>&#9679; <a href="<?php echo base_url ?>#hero">Home</a></b></label>
                ...
                <label><b>&#9679; <a href="<?php echo base_url ?>login">Login</a></b></label>
                    ...
                    <p style="margin-left:30px;">&#9675; <a href="<?php echo base_url ?>login/forgot">Forgot password</a></p>
                <label><b>&#9679; The Municipal Agriculture Office</b></label>
                    <p style="margin-left:30px;">&#9675; <a href="<?php echo base_url ?>cookie-policy">Cookie Policy</a></p>
                    <p style="margin-left:30px;">&#9675; <a href="<?php echo base_url ?>privacy-policy">Privacy Policy</a></p>
                    <p style="margin-left:30px;">&#9675; <a href="<?php echo base_url ?>sitemap">Site Map</a></p>
                    <p style="margin-left:30px;">&#9675; <a href="<?php echo base_url ?>website-terms-condition">Terms of Use</a></p>

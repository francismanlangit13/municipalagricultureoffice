<?php include('../includes/authentication.php'); 
  ...
  if(isset($_POST['del_product'])){
    ...
    if($query_run){
      ...
      $_SESSION['status_code'] = "success";
      header("Location: " . base_url . "staff/home/product");
      exit(0);
    }
    else{
        ...
        if($fileSize < 10485760){
          ...
          if (move_uploaded_file($fileTmpname, $targetFile)) {
            ...
            if($query_run){
              ...
              $_SESSION['status_code'] = "success";
              header("Location: " . base_url . "staff/home/farmer_account");
              exit(0);
            }
            else{
  ...
  if(isset($_POST['category_delete'])){
    ...
    if(mysqli_num_rows($sql_run) > 0){
      ...
      $_SESSION['status_code'] = "error";
      header("Location: " . base_url . "staff/home/product_category");
      exit(0);
    }
    else{
  ...
  if(isset($_POST['add_announcement'])){
    ...
    if($query_run){
      ...
      $_SESSION['status_code'] = "success";
      header("Location: " . base_url . "staff/home/announcement");
      exit(0);
    }
    else{
  ...
  if(isset($_POST['update_account'])){
    ...
    if(isset($_FILES['image']) && is_uploaded_file($_FILES['image']['tmp_name']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        if($fileError === 0){
            ...
            $_SESSION['status']="File is too large file must be 10mb";
            $_SESSION['status_code'] = "error"; 
            header("Location: " . base_url . "staff/home/settings");
            }
        }
        else{
            $_SESSION['status']="File Error";
